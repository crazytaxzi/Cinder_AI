...
def prepare(args: argparse.Namespace) -> None:
    ...
    values.update({
        ...
        'CINDER_VOICE_SOCIAL_MODEL': 'gpt-5.4-mini',
        'CINDER_VOICE_CLOUD_TRANSCRIPTION': 'true',
        'CINDER_VOICE_CLOUD_STT_USD_PER_MINUTE': '0.003',
        'CINDER_VOICE_CLOUD_TTS': 'true',
        'CINDER_VOICE_CLOUD_TTS_USD_PER_MINUTE': '0.015',
        'CINDER_SOCIAL_CONTEXT_EVENT_LIMIT': '10',
        'CINDER_SOCIAL_MAX_REPLY_CHARACTERS': '500',
        'CINDER_VOICE_CONTEXT_EVENT_LIMIT': '6',
        'CINDER_VOICE_MAX_REPLY_CHARACTERS': '220',
        'CINDER_VOICE_SPEECH_END_MS': '550',
        'CINDER_VOICE_SPEED': '0.468',
        'CINDER_VOICE_PITCH': '0.538055352',
        'DISCORD_VOICE_DAVE_ENCRYPTION': values.get('DISCORD_VOICE_DAVE_ENCRYPTION') or 'false',
        'DISCORD_VOICE_DECRYPTION_FAILURE_TOLERANCE': values.get('DISCORD_VOICE_DECRYPTION_FAILURE_TOLERANCE') or '3',
        'DISCORD_VOICE_RECEIVE_RECOVERY_COOLDOWN_MS': values.get('DISCORD_VOICE_RECEIVE_RECOVERY_COOLDOWN_MS') or '15000',
